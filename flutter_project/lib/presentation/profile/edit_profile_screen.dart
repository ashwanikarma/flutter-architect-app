...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Edit Profile', style: TextStyle(color: AppColors.textMainOf(context))),
        centerTitle: true,
        backgroundColor: AppColors.backgroundOf(context),
        foregroundColor: AppColors.textMainOf(context),
        elevation: 0,
        leading: IconButton(
          ...
          child: Column(
            ...
            children: [
              ...
              CircleAvatar(
                ...
                child: Icon(_avatarIcons[_selectedAvatarIndex], size: 52, color: AppColors.primaryBlue),
              ),
              const SizedBox(height: 16),
              Align(
                alignment: Alignment.centerLeft,
                child: Text('Choose Avatar', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textMainOf(context))),
              ),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Icon(_avatarIcons[index], size: 28, color: isSelected ? Colors.white : AppColors.textMutedOf(context)),
                      ),
                    );
                  },
                ),
  ...
  Widget _buildLabel(String text) {
    return Align(
      alignment: Alignment.centerLeft,
      child: Text(text, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textMainOf(context))),
    );
  }
